...
def visualize_points_list(points_list, vis_category, extra_pcd = None, axis_marker = 5, title = None, colors_list = colors_list):
    num = len(colors_list)
    pcds = []
    ...
    #     # pcd.paint_uniform_color(vis_category[i])
